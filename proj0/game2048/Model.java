...
public class Model extends Observable {
    ...
    public static boolean atLeastOneMoveExists(Board b) {
        ...
        // Go row by row, and check if there are any adjacent tiles with equal values
        for (int row = 0; row < b.size(); ++row) {
        ...
        // Go column by column, and check if there are any adjacent tiles with equal values
        for (int col = 0; col < b.size(); ++col) {
